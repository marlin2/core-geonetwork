...
public class DataManager {
    ...
    public String startEditingSession(ServiceContext context, String id, Boolean lock) throws Exception {
        return metadataUtils.startEditingSession(context, id, lock);
    }
    ...
    @Deprecated
    public IMetadata insertMetadata(ServiceContext context, Metadata newMetadata, Element metadataXml, boolean notifyChange, boolean index,
    ...
    public Element updateFixedInfo(String schema, Optional<Integer> metadataId, String uuid, Element md, String parentUuid,
        ...
        return metadataManager.updateFixedInfo(schema, metadataId, uuid, md, parentUuid, updateDatestamp, context, created);
    }
