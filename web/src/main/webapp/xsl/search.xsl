              ...
              <xsl:attribute name="style">display:none;</xsl:attribute>
				...
				<xsl:choose>
					<xsl:when test="/root/request/debug">
                        ...
                        <script type="text/javascript">
                            <xsl:attribute name="src"><xsl:value-of
                                select="$baseUrl" />/apps/html5ui/js/MarLIN/app.SearchField.js</xsl:attribute>
                        </script>
                        <script type="text/javascript">
                            <xsl:attribute name="src"><xsl:value-of
                                select="$baseUrl" />/apps/html5ui/js/MarLIN/KeywordSelectionPanel.js</xsl:attribute>
                        </script>
                        <script type="text/javascript">
                            <xsl:attribute name="src"><xsl:value-of
                                select="$baseUrl" />/apps/html5ui/js/MarLIN/SearchFormTools.js</xsl:attribute>
                        </script>
                        <script type="text/javascript">
                            <xsl:attribute name="src"><xsl:value-of
